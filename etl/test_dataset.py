...
output_dir1 = "data/test/sorted_store"
output_dir2 = "data/test/sorted_dept"
dept_path = "data/test/sorted_store_dept"
    ...
    def seperate_store_dept():
        ...
        for file in store:
            ...
            for dept in dept_groups:
                ...
                result_path = f"data/test/sorted_store_dept/store_{store_id}"
